/obj/structure/stalker/cars
	name = "car"
	density = 1

/obj/structure/stalker/cars/gryzovik
	name = "Gruzovik"
	desc = "Старый советский груховик со спущенными шинами."

/obj/structure/stalker/cars/gryzovik/south
	icon = 'icons/stalker/cars/gruzovik_south.dmi'
	icon_state = "1"

/obj/structure/stalker/cars/gryzovik/north
	icon = 'icons/stalker/cars/gruzovik_north.dmi'
	icon_state = "1"

/obj/structure/stalker/cars/gryzovik/west
	icon = 'icons/stalker/cars/gruzovik_west.dmi'
	icon_state = "1"

/obj/structure/stalker/cars/gryzovik/east
	icon = 'icons/stalker/cars/gruzovik_east.dmi'
	icon_state = "1"

/obj/structure/stalker/cars/gryzovik2
	name = "Gruzovik"
	desc = "Старый советский груховик со спущенными шинами."

/obj/structure/stalker/cars/gryzovik2/south
	icon = 'icons/stalker/cars/gruzovik2_south.dmi'
	icon_state = "1"

/obj/structure/stalker/cars/moskvich/south
	icon = 'icons/stalker/cars/moskvich1_south.dmi'
	icon_state = "1"

/obj/structure/stalker/cars/moskvich/south/hyi
	icon = 'icons/stalker/cars/moskvich2_south.dmi'

/obj/structure/stalker/cars/uaz
	name = "UAZ"
	icon = 'icons/stalker/cars/uaz-469_south.dmi'
	desc = "Ржавый, но все еще работает. Только бензин закончилс&#255;."

/obj/structure/stalker/cars/mi24
	name = "MI24"
