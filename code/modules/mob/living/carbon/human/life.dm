...
/mob/living/carbon/human/proc/handle_artefacts()
	if(src.belt && istype(src.belt, /obj/item/weapon/storage/belt/stalker/artefact_belt))
		var/obj/item/weapon/storage/belt/stalker/artefact_belt/art_belt = src.belt
		art_belt.Think()
	else
