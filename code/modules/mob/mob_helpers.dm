...
/proc/derpspeech(message, stuttering)
	message = replace_text(message, " am ", " ")
	message = replace_text(message, " is ", " ")
	message = replace_text(message, " are ", " ")
	message = replace_text(message, "you", "u")
	message = replace_text(message, "help", "halp")
	message = replace_text(message, "grief", "grife")
	message = replace_text(message, "space", "spess")
	message = replace_text(message, "carp", "crap")
	message = replace_text(message, "reason", "raisin")
	if(prob(50))
