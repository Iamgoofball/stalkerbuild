...
/obj/item/clothing/mask/gas/voice/space_ninja/speechModification(message)
	if(voice == "Unknown")
		if(copytext(message, 1, 2) != "*")
			...
			message = replace_text(message, "l", "r")
			message = replace_text(message, "rr", "ru")
			message = replace_text(message, "v", "b")
			message = replace_text(message, "f", "hu")
			message = replace_text(message, "'t", "")
			message = replace_text(message, "t ", "to ")
			message = replace_text(message, " I ", " ai ")
			message = replace_text(message, "th", "z")
			message = replace_text(message, "is", "izu")
			message = replace_text(message, "ziz", "zis")
			message = replace_text(message, "se", "su")
			message = replace_text(message, "br", "bur")
			message = replace_text(message, "ry", "ri")
			message = replace_text(message, "you", "yuu")
			message = replace_text(message, "ck", "cku")
			message = replace_text(message, "eu", "uu")
			message = replace_text(message, "ow", "au")
			message = replace_text(message, "are", "aa")
			message = replace_text(message, "ay", "ayu")
			message = replace_text(message, "ea", "ii")
			message = replace_text(message, "ch", "chi")
			message = replace_text(message, "than", "sen")
